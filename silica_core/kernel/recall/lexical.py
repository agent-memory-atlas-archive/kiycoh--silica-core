...
from silica_core.kernel.recall.paths import DiskSynced
...
class LexicalStore(DiskSynced):
    ...
    def _reindex(self) -> None:
        ...
        from silica_core.kernel.recall.paths import build_postings
    ...
    def _read_disk(self) -> dict[str, Any]:
        try:
            ...
            from silica_core.kernel.recall.paths import quarantine
...
def get_lexical_store() -> "LexicalStore":
    from silica_core.kernel.recall.paths import path_keyed_singleton
...
def get_store(name: str) -> "LexicalStore":
    ...
    One index per consumer. The retrieval engine (silica_core/core.py) builds by
    ...
    from silica_core.kernel.recall.paths import index_file, path_keyed_singleton
