...
from silica_core.kernel.recall.paths import is_source_leaf
from silica_core.kernel.write.ops import InverseOp, InverseOpKind
...
class ObsidianWSBackend(GraphIndexMixin):
    ...
    def list_inbox_files(self) -> list[NoteRef]:
        from silica_core.kernel.vault_manifest import active_inbox_dir
    ...
    def _resolve_link(self, target: str, source_path: str = "") -> NoteRef | None:
        ...
        from silica_core.kernel.link.ast import resolve_relative
