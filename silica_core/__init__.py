...
# at import time, before silica_core.config is reached. The package root is the
# earliest point silica controls: it runs before any submodule, hence before any
# third-party import. Re-exported as silica_core.config.VAULT_PINNED, its usual name.
...
try:
    ...
    try:
        ...
        __version__ = _pkg_version("silica-core")
