...
in silica_core/__init__.py, ahead of every third-party import. Subprocesses because
...
_PROBE = "import silica_core.cli, silica_core.config; print(silica_core.config.VAULT_PINNED)"
